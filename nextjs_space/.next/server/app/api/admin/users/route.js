...
/* harmony import */ var _home_ubuntu_instagram_content_generator_nextjs_space_app_api_admin_users_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/admin/users/route.ts */ "(rsc)/./app/api/admin/users/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    ...
    resolvedPagePath: "/home/ubuntu/instagram_content_generator/nextjs_space/app/api/admin/users/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_instagram_content_generator_nextjs_space_app_api_admin_users_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
...
async function GET(request) {
    try {
        ...
        if (!user || user.role !== "ADMIN") {
            return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.json({
                error: "Acc\xe8s refus\xe9. Administrateur requis."
            }, {
                status: 403
            });
        }
