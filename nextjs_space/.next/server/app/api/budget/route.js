...
(() => {
var exports = {};
exports.id = "app/api/budget/route";
exports.ids = ["app/api/budget/route"];
exports.modules = {
...
/* harmony import */ var _home_ubuntu_instagram_content_generator_nextjs_space_app_api_budget_route_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/api/budget/route.ts */ "(rsc)/./app/api/budget/route.ts");
...
const routeModule = new next_dist_server_future_route_modules_app_route_module_compiled__WEBPACK_IMPORTED_MODULE_0__.AppRouteRouteModule({
    definition: {
        ...
        page: "/api/budget/route",
        pathname: "/api/budget",
        filename: "route",
        bundlePath: "app/api/budget/route"
    },
    resolvedPagePath: "/home/ubuntu/instagram_content_generator/nextjs_space/app/api/budget/route.ts",
    nextConfigOutput,
    userland: _home_ubuntu_instagram_content_generator_nextjs_space_app_api_budget_route_ts__WEBPACK_IMPORTED_MODULE_3__
});
// Pull out the exports that we need to expose from the module. This should
// be eliminated when we've moved the other routes to the new format. These
// are used to hook into the route.
const { requestAsyncStorage, staticGenerationAsyncStorage, serverHooks } = routeModule;
const originalPathname = "/api/budget/route";
function patchFetch() {
 ...
 */ async function GET(request) {
    try {
        ...
        const jobs = await _lib_db__WEBPACK_IMPORTED_MODULE_3__.prisma.contentJob.findMany({
            where: {
